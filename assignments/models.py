...
class Assignment(models.Model):
    ...
    assignment_type = models.CharField(
        max_length=20, choices=Type.choices, default=Type.HOMEWORK
    )
    ...
    discipline = models.ForeignKey(
        Discipline, on_delete=models.CASCADE, related_name="assignments"
    )
    teacher = models.ForeignKey(
        "users.Teacher", on_delete=models.CASCADE, related_name="assignments"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Grade(models.Model):
    ...
    teacher = models.ForeignKey(
        "users.Teacher", on_delete=models.CASCADE, related_name="grades"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
