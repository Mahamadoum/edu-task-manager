...
from .forms import AssignmentForm, DisciplineForm
from .models import Assignment, Discipline, Submission
...
def assignment_edit(request, pk):
    ...
    if (
        ...
        and assignment.teacher != request.user.teacher_profile
    ...
    return render(
        request, "assignments/edit.html", {"form": form, "assignment": assignment}
    )
...
def discipline_list(request):
    ...
    return render(
        request, "assignments/disciplines/list.html", {"disciplines": disciplines}
    )
...
def discipline_create(request):
    ...
    return render(
        request,
        "assignments/disciplines/form.html",
        {"form": form, "title": "Ajouter une matière"},
    )
...
def discipline_edit(request, pk):
    ...
    return render(
        request,
        "assignments/disciplines/form.html",
        {"form": form, "title": "Modifier une matière"},
    )
...
def discipline_delete(request, pk):
    ...
    if request.method == "POST":
        ...
        return redirect("assignments:discipline_list")
    return render(
        request, "assignments/disciplines/delete.html", {"discipline": discipline}
    )
