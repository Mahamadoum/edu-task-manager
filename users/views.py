...
from .forms import UserRegistrationForm, UserLoginForm, UserUpdateForm, TeacherForm, StudentForm
...
def teacher_create(request):
    if request.method == 'POST':
        ...
        form = TeacherForm()
    return render(request, 'admin/teachers/form.html', {'form': form, 'title': 'Ajouter un enseignant'})
...
def teacher_edit(request, pk):
    ...
    return render(request, 'admin/teachers/form.html', {'form': form, 'title': 'Modifier un enseignant'})
...
def teacher_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('teacher_list')
    return render(request, 'admin/confirm_delete.html', {'object': teacher, 'type': 'enseignant'})
...
def student_create(request):
    if request.method == 'POST':
        ...
        form = StudentForm()
    return render(request, 'admin/students/form.html', {'form': form, 'title': 'Ajouter un étudiant'})
...
def student_edit(request, pk):
    ...
    return render(request, 'admin/students/form.html', {'form': form, 'title': 'Modifier un étudiant'})
...
def student_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('student_list')
    return render(request, 'admin/confirm_delete.html', {'object': student, 'type': 'étudiant'})