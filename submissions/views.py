...
from assignments.forms import GradeForm, SubmissionForm
...
def submission_create(request, assignment_pk):
    ...
    return render(
        request, "submissions/create.html", {"form": form, "assignment": assignment}
    )
...
def grade_create(request, submission_pk):
    ...
    if request.method == "POST":
        ...
        form = GradeForm()
    return render(
        request, "submissions/grade.html", {"form": form, "submission": submission}
    )
